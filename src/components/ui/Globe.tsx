...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  useEffect(() => {
    ...
    globeMaterial.color.set(globeConfig.globeColor || "#000");
    globeMaterial.emissive.set(globeConfig.emissive || "#000");
  ...
  useEffect(() => {
    ...
    const filteredPoints: PointData[] = points.filter(
      (v, i, a) =>
        a.findIndex((v2) =>
          ["lat", "lng"].every(
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      globeRef.current.ringsData(ringsData as RingData[]);
    }, 2000);
